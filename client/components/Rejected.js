...
//   useEffect(() => {
//     if (currentIndex >= rejectedMovies.length) {
//       setCurrentIndex(0); // Reset to 0 if currentIndex goes out of bounds
//     }
//   }, [rejectedMovies, currentIndex]);

//   // If there are no rejected movies, display a message
...
//     try {
//       // Dispatch the updateSingleRating action to change the rating to "Yes"
//       await dispatch(
//         updateSingleRating({
//           id: userRating.id,
//           userId: id,
...
//   useEffect(() => {
//     // Mark as finished if we've gone through all rejected movies
//     if (currentIndex >= rejectedMovies.length) {
//       setHasFinished(true);
//     }
//   }, [currentIndex, rejectedMovies.length]);

//   // Handle advancing to the next movie
//   const handleNextMovie = () => {
//     if (currentIndex < rejectedMovies.length - 1) {
//       setCurrentIndex(currentIndex + 1);
//     } else {
//       setHasFinished(true); // Mark as finished when reaching the end
//     }
//   };
...
//   const movie = hasFinished ? null : rejectedMovies[currentIndex];
